  ...
  Future<void> _fetchDevis() async {
    try {
      ...
      for (var devis in devisStations) {
        ...
        print('Valeur Arriver: ${devis.valeurArriver}');
        print('Valeur De Depart: ${devis.valeurDeDepart}');
        print('Prix Unité: ${devis.prixUnite}');
        print('Consommation: ${devis.consommation}');
        print('Budget Obtenu: ${devis.budgetObtenu}');
        print('Date de création: ${devis.dateAddDevis}');
      }
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                SizedBox(width: 5),
                                Text(
                                  devis.valeurArriver?.toString() ?? 'N/A',
                                  style: TextStyle(
                                    fontSize: 10,
                                    color: Colors.black.withOpacity(0.8),
                                  ),
