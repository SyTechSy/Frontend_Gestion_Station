...
class ModifierDevisGasoil extends StatelessWidget {
  final int devisId;
  final DevisGasoilModel devis;
  const ModifierDevisGasoil({super.key, required this.devisId, required this.devis});
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          PageChampsModifierGasoilInput(devisId: devisId, devis: devis,)
        ],
...
class PageChampsModifierGasoilInput extends StatefulWidget {
  final int devisId;
  final DevisGasoilModel devis;
  const PageChampsModifierGasoilInput({super.key, required this.devisId, required this.devis});

  @override
  State<PageChampsModifierGasoilInput> createState() => _PageChampsModifierGasoilInputState();
}

class _PageChampsModifierGasoilInputState extends State<PageChampsModifierGasoilInput> {
  ...
  void _modifierDevisGasoil() async {
    setState(() {
      isLoading = true;
    });
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: _modifierDevisGasoil,
                ),
              ),
            ],
          ),
